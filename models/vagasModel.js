...
const criarVaga = async (id_usuario, titulo, descricao, requisitos, setor, salario) => {
    const query = "INSERT INTO vaga (id_usuario, titulo, descricao, requisitos, setor, salario) values ($1, $2, $3, $4, $5, $6) RETURNING *";
...
const atualizarVaga = async (id, dados) => {
  ...
  const { rows } = await conexao.query(query, [titulo, descricao, requisitos, setor, salario, id])
